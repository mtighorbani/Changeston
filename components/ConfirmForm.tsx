    ...
    >
      ...
      >
        <div className="bg-[#F9FAFB] dark:bg-[#374151] w-full h-32 mt-8 rounded-xl ">
          {
            // TODO : remove ti=his condition when images added
        ...
        <div
          ...
          className="w-[30%]  text-center cursor-not-allowed h-10 text-white pr-3 pt-[7px] mt-10 mr-6  rounded-lg font-bold bg-gradient-to-r from-[#C8338C] to-[#0A95E5]  "
        >
          تایید و پرداخت
        </div>
      </div>
