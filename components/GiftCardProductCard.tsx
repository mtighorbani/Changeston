import { GooglePlay, VerifiedPanels } from "@/models/models";
...
const GiftCardProductCard = (props: Props) => {
  //TODO: fix image src
  //TODO: fix alignment
  return (
    <div key={props.Item.id} onClick={props.onClick}>
      ...
      >
        ...
        <p className="font-extrabold max-sm:font-normal font-lg pb-10 ">
          {props.Item.currency_type === "usd"
            ? "$"
            : props.Item.currency_type === "euro" && "€"}
          {props.Item.amount}
        </p>
      </div>
    </div>
...
export default GiftCardProductCard;
