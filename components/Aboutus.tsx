...
const Aboutus = () => {
  return (
    <div className="w-[80%] h-96 mx-auto flex justify-center my-20 max-sm:my-8 max-sm:mb-60" dir="rtl">
      <div className=" w-[80%] pt-6">
        <h1 className=" font-bold text-2xl ">چرا ما؟</h1>
        <div className=" pt-8 grid grid-cols-3 max-sm:w-full max-sm:grid-cols-1">
          <div className="w-[70%] h-28  rounded-sm max-sm:mb-10">
          ...
          <div className="w-[70%] max-sm:w-full max-sm:mb-10 h-28  rounded-sm ">
          ...
          <div className="w-[70%]  max-sm:w-full h-28  rounded-sm ">
      ...
      {<div className="w-[30%] h-[70%] rounded-l-[150px]  bg-gradient-to-r from-[#C8338C] to-[#0A95E5] max-sm:hidden "></div>}
    </div>
  );
};
